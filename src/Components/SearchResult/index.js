...
class SearchResult extends Component {
  ...
  handleChange = (pageNumber) => {
    ...
    if (pageNumber === 1) {
      ...
      resultToRender = filterResults.slice(
        (pageNumber - 1) * 10,
        pageNumber * 10
      );
    }
    ...
    filterResults = results.filter((data) => {
      return (
        data.addresses[0].city
          .toLowerCase()
          .indexOf(filters.cityName.toLowerCase()) !== -1 &&
        data.addresses[0].postal_code
          .toLowerCase()
          .indexOf(filters.zipCode.toLowerCase()) !== -1 &&
        data.basic.gender
          .toLowerCase()
          .indexOf(filters.gender.toLowerCase()) !== -1 &&
        data.taxonomies[0].desc
          .toLowerCase()
          .indexOf(filters.providerCategory.toLowerCase()) !== -1 &&
        data.taxonomies[0].desc
          .toLowerCase()
          .indexOf(filters.specialProviderCategory.toLowerCase()) !== -1
      );
    });
    this.setState({
      filterResults,
            ...
            <Col md={5} sm={24} xs={24} className="search-content">
                  ...
                  <Row className="input-spacing">
                    <div>
                      ...
                      <Input
                        ...
                        placeholder="E.g San Francisc"
                        onChange={this.handleFiltersInputChange("cityName")}
                      />
                    </div>
                  </Row>
                  <Row className="input-spacing">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={this.handleFiltersInputChange("zipCode")}
                      />
                    </div>
                  </Row>
                  <Row className="input-spacing">
                    <div>
                      ...
                      >
                        ...
                        <Option value="Nurse Practitioner Family">
                          Nurse Practitioner Family
                        </Option>
                        <Option value="Physical Therapist Orthopedic">
                          Physical Therapist Orthopedic
                        </Option>
                        <Option value="Social Worker Clinical">
                  ...
                  <Row className="input-spacing">
                    <div className="input-spacing">
                      <label className="input-label">
                        SPECIALITY BY PROVIDER CATEGORY
                      </label>
                      <Select
                        showSearch
                        className="search-input"
                      ...
                      >
                        <Option value="">All</Option>
                        <Option value="Obstercician/Gynecologis">
                          Obstercician
                        </Option>
                        ...
                        <Option value="Dentist Endodontics">
                          Dentist Endodontics
                        </Option>
                        ...
                        <Option value="Dentist Ora and Maxillofacial Surgery">
                          Dentist Ora and Maxillofacial Surgery
                        </Option>
                    ...
                    <Row>
                      <div>
                        <p className="advance-search" onClick={this.handleHide}>
                          {hide ? "SHOW" : "HIDE"} ADVANCED SEARCH{" "}
                          <Icon type={hide ? "caret-down" : "caret-up"} />
                        </p>
                      </div>
                    </Row>
                    {hide ? (
                        ...
                        <div>
                          ...
                          <ul className="input-ul">
                            ...
                            <li>
                              <Checkbox
                                className="input-checkbox"
                                value="Both Adults and Children"
                              >
                            ...
                            <li>
                              <Checkbox
                                className="input-checkbox"
                                value="Children & Adolescents Only"
                              >
                          ...
                          <ul className="input-ul">
                            <li>
                              <Checkbox
                                ...
                                value="F"
                                onChange={this.handleFiltersCheckBoxChange(
                                  "female"
                                )}
                              >
                                Female
              ...
              <Row style={{ display: "flex", justifyContent: "center" }}>
                ...
                >
                  <Icon
                    style={{ fontSize: 20 }}
                    type={hideAdvSearch ? "caret-up" : "caret-down"}
                  />
                </Col>
              </Row>
            </Col>
            ...
            <Col md={19} sm={24} xs={24} className="search-result-body">
              <Row type="flex" justify="center">
                <Col
                  ...
                  sm={22}
                  xs={24}
                  className="search-result-body-setting"
                >
                  <Row>
                    <Col lg={18} md={18} sm={15} xs={15}>
                      <h1 className="search-result-number">
                        {filterResults.length}{" "}
                        <span style={{ color: "#000000" }}> Doctors</span>
                      </h1>
                    </Col>
                    <Col
                      lg={6}
                          ...
                          <Row key={index} className="profile-list">
                            ...
                            <Col xl={12} lg={12} md={12} sm={12} xs={12}>
                              <Row type="flex">
                                <Row style={{ width: "100%" }} type="flex">
                                  <h4>
                                    {value.basic.name}, {value.basic.credential}
                                  </h4>
                                </Row>
                                <Row style={{ width: "100%" }} type="flex">
                                  <h5
                                  ...
                                  >
                                    {value.taxonomies[0].desc}
                                  </h5>
                                </Row>
                                <Row style={{ width: "100%" }} type="flex">
                                  <h5 style={{ fontSize: "10px !important" }}>
                                    ADDRESS
                                  </h5>
                                </Row>
                                <Row style={{ width: "100%" }} type="flex">
                                  <h5>
                                    {value.addresses[0].address_1} -
                                    <span
                                ...
                                <Button
                                  ...
                                  onClick={() => this.goToProfile(value)}
                                >
                                  VIEW PROFILE
                                </Button>
                              </Row>
                            ...
                            <Col xl={6} lg={6} md={6} sm={6} xs={24}>
                              <Row className="profile-list-call-container">
                                <Row type="flex" justify="center">
                                  <p className="profile-list-call profile-list-call-text">
                                    CALL
                                  </p>
                                </Row>
                                <Row type="flex" justify="center">
                                  <h3 className="profile-list-call profile-list-call-no">
                                    {value.number
                                      .toString()
                                      .substring(0, 7)
                                      .match(/.{1,3}/g)
                                      .join(".")}
                                    {value.number.toString().substring(7)}
                                  </h3>
                                </Row>
                              </Row>
                            </Col>
